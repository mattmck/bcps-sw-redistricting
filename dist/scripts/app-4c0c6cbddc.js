...
angular.module("redistricting").run(["$templateCache", function($templateCache) {$templateCache.put("app/main/main.html","<div class=\"container-fluid\"><div class=\"row\"><div class=\"col-md-12\"><leaflet defaults=\"defaults\" lf-center=\"center\" width=\"100%\" height=\"400px\"></leaflet></div></div><div class=\"row\"><div class=\"col-md-12\"><div class=\"panel panel-default\"><div class=\"panel-body\"><button ng-click=\"takeSnapshot()\" class=\"btn btn-default\"><span ng-hide=\"snapshotInProgress\">Take Snapshot</span><i class=\"fa fa-cog fa-spin\" ng-hide=\"!snapshotInProgress\"></i></button> <button ng-click=\"loadCurrent()\" class=\"btn btn-default\">Current Districting</button></div></div></div></div><div class=\"row col-md-12\"><div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\">11/18/2015 Meeting</h4></div><div class=\"panel-body\"><button ng-click=\"loadOption11118()\" class=\"btn btn-default\">Option 1</button> <button ng-click=\"loadOption21118()\" class=\"btn btn-default\">Option 2</button> <button ng-click=\"loadOption31118()\" class=\"btn btn-default\">Option 3</button> <button ng-click=\"loadOption41118()\" class=\"btn btn-default\">Option 4</button></div></div></div><div class=\"row col-md-12\"><table ng-table=\"tableParams\" class=\"table table-condensed table-bordered\"><tr ng-repeat=\"school in $data\" ng-class=\"{\'selected-row\':selectedSchoolName === school.NAME}\"><td title=\"\'Color\'\"><div style=\"height:20px; width:20px; background:{{schoolColors[school.NAME]}}; display:table\"><div></div></div></td><td title=\"\'School\'\" sortable=\"\'NAME\'\">{{school.NAME}}</td><td title=\"\'2015 Cap.\'\" sortable=\"\'school.SRC\'\">{{school.SRC}}</td><td title=\"\'2016 Cap.\'\" sortable=\"\'school.SRC2016 !== undefined ? school.SRC2016 : school.SRC\'\">{{school.SRC2016 !== undefined ? school.SRC2016 : school.SRC}}</td><td title=\"\'2017 Cap.\'\" sortable=\"\'school.SRC2017 !== undefined ? school.SRC2017 : school.SRC2016 !== undefined ? school.SRC2016 : school.SRC\'\">{{school.SRC2017 !== undefined ? school.SRC2017 : school.SRC2016 !== undefined ? school.SRC2016 : school.SRC}}</td><td title=\"\'2015 %\'\" sortable=\"\'school.SRC\'\"><em ng-class=\"{\'text-danger\':school.students / school.SRC > 1}\">{{Math.round(school.students / school.SRC * 100)}}%</em></td><td title=\"\'2016 %.\'\" sortable=\"\'school.SRC2016 !== undefined ? school.SRC2016 : school.SRC\'\"><em ng-class=\"{\'text-danger\':school.students / (school.SRC2016 !== undefined ? school.SRC2016 : school.SRC) > 1}\">{{Math.round(school.students / (school.SRC2016 !== undefined ? school.SRC2016 : school.SRC)*100)}}%</em></td><td title=\"\'2017 %\'\" sortable=\"\'school.SRC2017 !== undefined ? school.SRC2017 : school.SRC2016 !== undefined ? school.SRC2016 : school.SRC\'\"><em ng-class=\"{\'text-danger\':school.students / (school.SRC2017 !== undefined ? school.SRC2017 : school.SRC2016 !== undefined ? school.SRC2016 : school.SRC) > 1}\">{{Math.round(school.students / (school.SRC2017 !== undefined ? school.SRC2017 : school.SRC2016 !== undefined ? school.SRC2016 : school.SRC)*100)}}%</em></td><td title=\"\'Students\'\" sortable=\"\'school.students\'\">{{school.students}}</td><td title=\"\'% Walkable\'\" sortable=\"\'school.walkablePercent\'\">{{Math.round(school.walkablePercent*100)}}%</td></tr></table></div><div class=\"row col-xs-12\"><div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\">9/30/2015 Meeting</h4></div><div class=\"panel-body\"><button ng-click=\"loadOption1()\" class=\"btn btn-default\">Option 1</button> <button ng-click=\"loadOption2()\" class=\"btn btn-default\">Option 2</button> <button ng-click=\"loadOption3()\" class=\"btn btn-default\">Option 3</button></div></div><div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\">10/14/2015 Meeting</h4></div><div class=\"panel-body\"><button ng-click=\"loadOptionA()\" class=\"btn btn-default\">Option A</button> <button ng-click=\"loadOptionB()\" class=\"btn btn-default\">Option B</button> <button ng-click=\"loadOptionC()\" class=\"btn btn-default\">Option C</button> <button ng-click=\"loadOptionD()\" class=\"btn btn-default\">Option D</button> <button ng-click=\"loadOptionE()\" class=\"btn btn-default\">Option E</button></div></div><div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\">10/28/2015 Meeting</h4></div><div class=\"panel-body\"><button ng-click=\"loadOptionA1021()\" class=\"btn btn-default\">Option A</button> <button ng-click=\"loadOptionB1021()\" class=\"btn btn-default\">Option B</button> <button ng-click=\"loadOptionC1021()\" class=\"btn btn-default\">Option C</button> <button ng-click=\"loadOptionD1021()\" class=\"btn btn-default\">Option D</button> <button ng-click=\"loadOptionE1021()\" class=\"btn btn-default\">Option E</button> <button ng-click=\"loadOptionF1021()\" class=\"btn btn-default\">Option F</button> <button ng-click=\"loadOptionG1021()\" class=\"btn btn-default\">Option G</button></div></div><div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\">11/11/2015 Meeting</h4></div><div class=\"panel-body\"><button ng-click=\"loadOptionA1111()\" class=\"btn btn-default\">Option A</button> <button ng-click=\"loadOptionB1111()\" class=\"btn btn-default\">Option B</button> <button ng-click=\"loadOptionC1111()\" class=\"btn btn-default\">Option C</button> <button ng-click=\"loadOptionD1111()\" class=\"btn btn-default\">Option D</button> <button ng-click=\"loadOptionE1111()\" class=\"btn btn-default\">Option E</button> <button ng-click=\"loadOptionF1111()\" class=\"btn btn-default\">Option F</button> <button ng-click=\"loadOptionG1111()\" class=\"btn btn-default\">Option G</button> <button ng-click=\"loadOptionH1111()\" class=\"btn btn-default\">Option H</button> <button ng-click=\"loadOptionI1111()\" class=\"btn btn-default\">Option I</button> <button ng-click=\"loadOptionJ1111()\" class=\"btn btn-default\">Option J</button> <button ng-click=\"loadOptionK1111()\" class=\"btn btn-default\">Option K</button> <button ng-click=\"loadOptionL1111()\" class=\"btn btn-default\">Option L</button></div></div></div><div ng-hide=\"hideSnapshot\" id=\"snapshot\"></div></div>");
